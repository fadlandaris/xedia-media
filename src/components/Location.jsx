...
const Location = () => {
  ...
  return (
    <main className={`${styles.containerPadding} `} id='our-location'>
      {/* <Graphic/> */}
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='border-2 border-blue-600 p-2 bg-blue-900 rounded-2xl overflow-hidden h-[420px]' data-aos="zoom-in" >
          <iframe 
